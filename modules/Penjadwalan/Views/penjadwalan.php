                                        ...
                                        foreach ($penjadwalan as $jadwal) : ?>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:center">
                                                    <button class="btn btn-info" onclick="duplikatJadwal(<?= $jadwal->penjadwalanId ?>)" data-toggle="modal" data-target="#clonePenjadwalan<?= $jadwal->penjadwalanId ?>"><i class="fas fa-clone"></i></button>
